...
class GuiPart:
  def __init__(self, master, queue, endCommand):
    ...
    self.L10 = Label(master, text="Entertainment")
    self.L10.grid( row=6, column=0, sticky = W, padx=10, pady=10)
    
    self.B10 = Button(master, text="Youtube Downloader", command=call)
    self.B10.grid( row=7, column=1, padx=6, pady=0,)
    self.B11 = Button(master, text="Pong Game", command=call2)
    self.B11.grid( row=9, column=1, padx=6, pady=2,)
